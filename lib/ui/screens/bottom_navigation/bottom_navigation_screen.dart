...
class BottomNavigationScreen extends StatelessWidget {
  ...
  static final List<Widget> _screens = [
    const Padding(
      ...
      child: Center(
        child: Text(
          "Welcome! Enjoy secure end-to-end encrypted chats with built-in hate speech detection.",
          textAlign: TextAlign.center, // Ensures text is centered
          style: TextStyle(
            fontSize: 18.0, // Makes text more readable
            fontWeight: FontWeight.w500, // Adds slight emphasis
            color: Colors.black87, // Improves visibility (adjust based on theme)
          ),
        ),
      ),
    ),
